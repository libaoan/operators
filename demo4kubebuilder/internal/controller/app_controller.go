...
import (
	"context"
	"demo4kubebuilder/internal/controller/utils"
	...
	ingressv1beta1 "demo4kubebuilder/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=ingress.github.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ingress.github.com,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ingress.github.com,resources=apps/finalizers,verbs=update
...
func (r *AppReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	//1. Deployment的处理, 如果不存在就创建，存在就更新
	...
	//2. Service的处理, 如果不存在且app配置了service支持就创建，存在就更新；不支持且存在service就删除
