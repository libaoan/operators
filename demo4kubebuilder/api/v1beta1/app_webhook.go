...
//+kubebuilder:webhook:path=/mutate-ingress-github-com-v1beta1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=ingress.github.com,resources=apps,verbs=create;update,versions=v1beta1,name=mapp.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-ingress-github-com-v1beta1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=ingress.github.com,resources=apps,verbs=create;update,versions=v1beta1,name=vapp.kb.io,admissionReviewVersions=v1
